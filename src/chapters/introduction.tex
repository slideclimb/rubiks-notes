...
To refer to a cubie, we will use a tuple or tripple of lowercase italic letters, e.g., \cubie{ur} refers to the edge cubie between the Up and the Right face, and \cubie{urf} refers to the corner cubie between the Up, Right, and Front face.
